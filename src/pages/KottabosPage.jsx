  ...
  return (
    <section ref={ref} style={{
      ...
      <motion.div style={{ y: bgY, position: 'absolute', inset: '-20%', zIndex: 0 }}>
        <img src="https://www.giornaledellabirra.it/wp-content/uploads/2018/10/kottabos-3.jpg"
      ...
      <motion.div style={{ y: textY, opacity, position: 'relative', zIndex: 3,
      ...
      >
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <motion.button onClick={() => navigate('/catalogo?cat=cerveza')}
          ...
          <motion.button onClick={() => document.getElementById('kottabos-historia')?.scrollIntoView({ behavior: 'smooth' })}
  ...
  return (
    <div style={{ background: COLORS.gold, overflow: 'hidden' }}>
      <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap',
        ...
        {[['2015','Fundación'],['3','Fundadoras'],['100%','Artesanal'],['330 · 750ml','Dos tamaños']].map(([num, label], i, arr) => (
...
function Story() {
  ...
  return (
    <section id="kottabos-historia" ref={ref} style={{
      background: COLORS.black, padding: 'clamp(80px,12vw,140px) clamp(20px,6%,80px)' }}>
      <div style={{ maxWidth: '1300px', margin: '0 auto',
        ...
        <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }}
          ...
          <div style={{ overflow: 'hidden', position: 'relative' }}>
            <motion.img style={{ scale: imgScale }}
              ...
              alt="Birrificio Kottabos"
              onError={(e) => { e.target.src = '/images/kottabos/kottabos-logo.jpg'; e.target.style.objectFit='contain'; e.target.style.background='#111'; e.target.style.padding='40px' }}
              style={{ width: '100%', height: 'clamp(320px, 48vw, 580px)',
                objectFit: 'cover', display: 'block', filter: 'brightness(0.85) contrast(1.05)' }} />
          </div>
          <div style={{ position: 'absolute', top: '-10px', left: '-10px', right: '10px', bottom: '10px',
            border: `2px solid ${COLORS.gold}`, zIndex: -1, pointerEvents: 'none' }} />
          <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0,
            background: `linear-gradient(transparent, ${COLORS.black}DD)`, padding: '50px 20px 16px' }}>
            <div style={{ fontSize: '10px', letterSpacing: '2px', color: COLORS.gold, fontFamily: SANS, fontWeight: 600 }}>
        ...
        <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }}
          ...
          <div style={{ fontSize: '10px', letterSpacing: '4px', color: COLORS.gold, fontFamily: SANS, fontWeight: 600, marginBottom: '16px' }}>NUESTRA HISTORIA</div>
          <h2 style={{ fontSize: 'clamp(2rem,4.5vw,3.5rem)', fontFamily: SERIF, fontStyle: 'italic', fontWeight: 300, color: COLORS.snow, marginBottom: '24px', lineHeight: 1.1 }}>
            Tres mujeres,<br /><span style={{ color: COLORS.gold }}>una pasión</span>
          </h2>
          <div style={{ width: '60px', height: '2px', background: COLORS.gold, marginBottom: '28px' }} />
          <p style={{ fontSize: 'clamp(14px,1.5vw,15px)', lineHeight: 1.9, color: `${COLORS.snow}BB`, fontFamily: SANS, marginBottom: '20px' }}>
          ...
          <p style={{ fontSize: 'clamp(14px,1.5vw,15px)', lineHeight: 1.9, color: `${COLORS.snow}BB`, fontFamily: SANS, marginBottom: '28px' }}>
            Sus cervezas son <strong style={{ color: COLORS.snow }}>no filtradas, no pasteurizadas</strong>, refermentadas en barril y botella. Elaboradas exclusivamente con agua, malta, lúpulo y levadura.
          </p>
          <p style={{ fontSize: 'clamp(14px,1.5vw,15px)', lineHeight: 1.9, color: `${COLORS.snow}BB`, fontFamily: SANS, marginBottom: '32px' }}>
          ...
          <blockquote style={{ borderLeft: `3px solid ${COLORS.gold}`, paddingLeft: '20px', margin: 0 }}>
            <p style={{ fontSize: 'clamp(15px,1.8vw,18px)', fontFamily: SERIF, fontStyle: 'italic', color: COLORS.gold, lineHeight: 1.6, margin: 0 }}>
              "Un piccolo birrificio, un grande cuore."
            </p>
            <div style={{ fontSize: '10px', letterSpacing: '2px', color: `${COLORS.snow}70`, fontFamily: SANS, fontWeight: 600, marginTop: '10px' }}>— BIRRIFICIO KOTTABOS</div>
          </blockquote>
        </motion.div>
      </div>
    </section>
...
/* ─── BEER SHOWCASE (individual flavor) ─────────────────── */
    ...
    <motion.div ref={ref} style={{ opacity, y: yCard }}>
      <div style={{
        ...
        <div style={{
          ...
          padding: 'clamp(32px,5vw,70px)', position: 'relative', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', width: '55%', height: '55%', borderRadius: '50%',
            background: `radial-gradient(circle, ${beer.color}25, transparent)`, bottom: '10%' }} />
          <motion.img style={{ y: imgY }} src={beer.image} alt={beer.name}
            style={{ height: 'clamp(220px, 38vh, 440px)', width: 'auto',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '8px', marginBottom: '20px', flexWrap: 'wrap' }}>
            {[`ABV ${beer.abv}`, `IBU ${beer.ibu}`].map(tag => (
              <span key={tag} style={{ padding: '4px 10px', border: `1px solid ${beer.color}50`,
                fontSize: '9px', letterSpacing: '1.5px', color: beer.color, fontFamily: SANS, fontWeight: 500 }}>
                {tag}
              </span>
            ))}
          </div>
          ...
          <div style={{ padding: '16px 0', borderTop: `1px solid ${beer.color}20`,
            ...
            <div style={{ fontSize: '13px', color: `${COLORS.snow}CC`, fontFamily: SANS }}>{beer.notes}</div>
          </div>

          <div style={{ marginBottom: '28px' }}>
            <div style={{ fontSize: '9px', letterSpacing: '2px', color: beer.color,
              fontFamily: SANS, fontWeight: 600, marginBottom: '8px' }}>MARIDAJE</div>
            <div style={{ fontSize: '13px', color: `${COLORS.snow}CC`, fontFamily: SANS }}>{beer.pairing}</div>
          </div>
          ...
          <div style={{ marginBottom: '28px' }}>
            ...
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              ...
              <div style={{ flex: '1 1 auto', padding: '12px 16px',
                ...
                background: `${beer.color}08` }}>
                <div style={{ fontSize: '11px', letterSpacing: '2px', color: beer.color,
                  fontFamily: SANS, fontWeight: 700, marginBottom: '4px' }}>
                  330 ml
                </div>
                <div style={{ fontSize: '12px', color: `${COLORS.snow}70`, fontFamily: SANS }}>
                  Consultar precio
                </div>
              </div>
              {/* 750ml */}
              <div style={{ flex: '1 1 auto', padding: '12px 16px',
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '3px' }}>
                  <span style={{ fontFamily: SERIF, fontStyle: 'italic',
                    fontSize: '1.3rem', color: COLORS.snow, fontWeight: 300 }}>
                    120
                  </span>
                  <span style={{ fontSize: '10px', color: `${COLORS.snow}AA`,
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            onClick={() => navigate(`/producto/kottabos-${beer.id}-330`)}
            style={{ alignSelf: 'flex-start', background: 'transparent',
              border: `1px solid ${beer.color}`, color: beer.color, padding: '12px 28px',
  ...
  return (
    <section style={{ background: '#080808' }}>
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        style={{ textAlign: 'center', padding: 'clamp(70px,10vw,120px) clamp(20px,6%,80px) clamp(40px,6vw,60px)' }}>
        <div style={{ fontSize: '10px', letterSpacing: '5px', color: COLORS.gold,
          fontFamily: SANS, fontWeight: 600, marginBottom: '16px' }}>
          SELEZIONE · 330ML & 750ML · BOTELLA DE VIDRIO
        </div>
      ...
      {BEERS.map((beer, i) => <BeerShowcase key={beer.id} beer={beer} index={i} />)}
    </section>
  )
}

/* ─── BOTH BOTTLE SIZES GRID ────────────────────────────── */
function BottlesGrid() {
  return (
    <section style={{ background: COLORS.black, padding: 'clamp(70px,10vw,120px) clamp(20px,5%,60px)' }}>
      <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
        style={{ textAlign: 'center', marginBottom: 'clamp(40px,8vw,70px)' }}>
        <h2 style={{ fontSize: 'clamp(1.8rem,4vw,3rem)', fontFamily: SERIF,
          fontStyle: 'italic', fontWeight: 300, color: COLORS.snow, marginBottom: '16px' }}>
          La colección completa
        </h2>
        <div style={{ width: '50px', height: '2px', background: COLORS.gold, margin: '0 auto 16px' }} />
        {/* Size legend */}
        <div style={{ display: 'flex', gap: '24px', justifyContent: 'center', flexWrap: 'wrap' }}>
          {[['330 ml', 'Consultar precio'], ['750 ml', '120 Bs.']].map(([size, price]) => (
            <div key={size} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <div style={{ width: '24px', height: '2px', background: COLORS.gold }} />
              <span style={{ fontSize: '11px', letterSpacing: '2px', color: `${COLORS.snow}99`,
        ...
        <div key={beer.id}>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }}
            ...
            style={{ textAlign: 'center', padding: '0 20px',
              ...
              marginTop: beerIdx > 0 ? 'clamp(50px,8vw,70px)' : '0' }}>
            <div style={{ fontSize: '9px', letterSpacing: '3px', color: beer.color,
              fontFamily: SANS, fontWeight: 600, textTransform: 'uppercase', marginBottom: '4px' }}>
              {beer.style}
            </div>
            <div style={{ fontSize: 'clamp(1.4rem,3.5vw,2.2rem)', fontFamily: SERIF,
              fontStyle: 'italic', color: COLORS.snow, fontWeight: 300 }}>
              {beer.name}
            </div>
          </motion.div>

          {/* 330ml + 750ml side by side */}
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr',
            gap: 'clamp(16px,3vw,40px)', maxWidth: '700px', margin: '0 auto' }}
            className="bottle-pair">
            {['330ml', '750ml'].map((size, sizeIdx) => (
              <motion.div key={size}
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, margin: '-60px' }}
                transition={{ duration: 0.7, delay: (beerIdx * 2 + sizeIdx) * 0.07 }}
                whileHover={{ y: -14 }}
                style={{ display: 'flex', flexDirection: 'column',
                  alignItems: 'center', gap: '16px', transition: 'all 0.4s ease' }}>
                ...
                <div style={{ position: 'relative', width: '100%',
                  ...
                  <div style={{ position: 'absolute', bottom: 0, left: '10%', right: '10%',
                    ...
                    filter: 'blur(16px)' }} />
                  <img src={beer.image} alt={`${beer.name} ${size}`}
                    style={{
                      height: size === '750ml' ? '100%' : '80%', // 750ml visually taller
                      width: 'auto', objectFit: 'contain',
                      filter: `drop-shadow(0 12px 24px ${beer.color}30)`,
                ...
                <div style={{ textAlign: 'center',
                  padding: '10px 16px',
                  border: `1px solid ${sizeIdx === 1 ? beer.color : `${beer.color}40`}`,
                  background: sizeIdx === 1 ? `${beer.color}15` : 'transparent',
                  width: '100%', boxSizing: 'border-box' }}>
                  <div style={{ fontSize: '12px', letterSpacing: '2px', color: beer.color,
                    fontFamily: SANS, fontWeight: 700, marginBottom: '4px' }}>
                    {size}
                  </div>
                  {sizeIdx === 1 ? (
                    <div style={{ display: 'flex', alignItems: 'baseline',
                      gap: '3px', justifyContent: 'center' }}>
                      <span style={{ fontFamily: SERIF, fontStyle: 'italic',
                        fontSize: '1.3rem', color: COLORS.snow, fontWeight: 300 }}>
                        120
                      </span>
                    ...
                    <div style={{ fontSize: '10px', letterSpacing: '1px',
                      color: `${COLORS.snow}60`, fontFamily: SANS }}>
                      Consultar precio
                    </div>
                  )}
                </div>
...
function Nebrodi() {
  ...
  return (
    <section ref={ref} style={{ position: 'relative',
      minHeight: 'clamp(400px, 60vh, 700px)', overflow: 'hidden', display: 'flex', alignItems: 'center' }}>
      <motion.div style={{ y: bgY, position: 'absolute', inset: '-15%', zIndex: 0 }}>
        <img src="https://wallpapercat.com/w/full/b/9/0/774515-1920x1200-desktop-hd-sicily-background-image.jpg"
          alt="Sicilia, Italia"
          onError={(e) => { e.target.src = 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Parco_dei_Nebrodi_-_San_Fratello.jpg/1280px-Parco_dei_Nebrodi_-_San_Fratello.jpg' }}
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
        ...
        style={{ position: 'relative', zIndex: 2,
          padding: 'clamp(60px,10vw,100px) clamp(24px,8%,100px)', maxWidth: 'min(650px, 90vw)' }}>
        ...
        <h2 style={{ fontSize: 'clamp(2.2rem,6vw,4.5rem)', fontFamily: SERIF,
          fontStyle: 'italic', fontWeight: 300, color: COLORS.snow, lineHeight: 1.05, marginBottom: '28px' }}>
          Nacida en el corazón<br /><span style={{ color: COLORS.gold }}>de Sicilia</span>
        </h2>
        <div style={{ width: '60px', height: '2px', background: COLORS.gold, marginBottom: '24px' }} />
        <p style={{ fontSize: 'clamp(14px,1.6vw,16px)', color: `${COLORS.snow}CC`, lineHeight: 1.9, fontFamily: SANS }}>
    ...
    <section style={{ background: COLORS.gold, textAlign: 'center',
      ...
      <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
        <h2 style={{ fontSize: 'clamp(1.8rem,4.5vw,3.2rem)', fontFamily: SERIF,
          fontStyle: 'italic', fontWeight: 300, color: COLORS.black, marginBottom: '16px' }}>
    ...
    <>
      <style>{`
        @media (max-width: 900px) {
          ...
          .bottle-pair { grid-template-columns: 1fr 1fr !important; max-width: 420px !important; }
        }
      `}</style>
      <Hero />
      <GoldStrip />
